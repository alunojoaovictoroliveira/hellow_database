...
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`fk_ingresso_cliente` (
  ...
  INDEX `fk_ingresso_has_cliente_cliente2_idx` (`cliente_id` ASC) ,
  INDEX `fk_ingresso_has_cliente_ingresso1_idx` (`ingresso_id` ASC) ,
  CONSTRAINT `fk_ingresso_has_cliente_ingresso1`
    FOREIGN KEY (`ingresso_id`)
    REFERENCES `hellow_eventos`.`ingresso` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ingresso_has_cliente_cliente2`
